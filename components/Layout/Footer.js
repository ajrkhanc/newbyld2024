              ...
              <div className="col-md-4 col-sm-6 md-mb-10">
                ...
                <ul className="address-widget">
                  <li>
                    ...
                    <div className="desc">
                      BYLD Group Private Limited, 2nd and 3rd Floor, Plot No.
                      48, Sector - 44, Opp. EPF Regional Office Gurugram,
                      Haryana - 122003
                    </div>
                  </li>
                  <li>
              ...
              <div className="col-md-3 col-sm-6">
                ...
                <ul className="footer-social md-mb-30">
                  <li>
                    ...
                    >
                      <span>
                        <i className="fa fa-facebook aff"></i>
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <span>
                        <i className="fa fa-linkedin all"></i>
                      </span>
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="https://twitter.com/BYLDGroup" target="_blank">
                      <span>
                        ...
                        <FaXTwitter className="att twitter-icon " />
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <span>
                        <i className="fa fa-youtube ayy"></i>
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <span>
                        <i className="fa fa-instagram aii"></i>
                      </span>
                    </a>
                  </li>
                </ul>
              ...
              <div className="col-lg-12">
                <div className="copyright text-lg-start text-center ">
                  <p className="text-center">
                    © 2025 BYLD Group Private Limited. All Rights Reserved.
                  </p>
                </div>
              </div>
            </div>
