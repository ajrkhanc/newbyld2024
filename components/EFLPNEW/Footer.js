            ...
            <div className="row">
              <div className="col-md-2 col-sm-12 md-mb-10">
                ...
                <ul className="site-map">
                  ...
                  <li>
                    <a href="/eaglesflightindia/blogs">Blog</a>
                  </li>
                  <li>
              ...
              <div className="col-md-3 md-mb-10">
                ...
                <ul className="address-widget">
                  <li>
                    ...
                    <div className="desc">
                      ...
                      Opp. EPF Regional Office Gurugram, Haryana - 122003
                    </div>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <div className="desc">
                      <a href="mailto:eaglesflightindia.info@byldgroup.com">
                        eaglesflightindia.info@byldgroup.com
                      </a>
                    </div>
                  </li>
                  <li>
                    <i className="flaticon-clock"></i>
                    <div className="desc">9:00 AM - 6:00 PM</div>
                  </li>
                </ul>
                ...
                <ul className="footer-social md-mb-30">
                  ...
                  <li>
                    <a href="https://twitter.com/ByldLearnings" target="_blank">
                  ...
                  <li>
                    <a
                      href="https://www.youtube.com/channel/UCfRDkIqa8kzNCDWA_VotHXw/videos"
                      target="_blank"
                    >
                      <span>
              ...
              <div className="col-md-4">
                ...
                <div className="bannerform">
                  <form
                    id="contact-form"
                    className="clientcornner ptt-30 pbb-10"
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-12 mb-12">
                        <select name="solutions" required>
                          ...
                          <option value="Museum Caper (Virtual Immersive Learning)">
                            Museum Caper (Virtual Immersive Learning)
                          </option>
                          <option value="King Kahufu (Virtual Immersive Learning)">
                            King Kahufu (Virtual Immersive Learning)
                          </option>
                          <option value="Gold of the Desert Kings">
                            Gold of the Desert Kings
                          </option>
                          <option value="Council of the Marble Star">
                            Council of the Marble Star
                          </option>
                          <option value="Rattlesnake Canyon">
                            Rattlesnake Canyon
                          </option>
                          <option value="Promises, Promises!">
                            Promises, Promises!
                          </option>
                          <option value="Expedition Outback">
                            Expedition Outback
                          </option>
