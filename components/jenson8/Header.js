        ...
        <header id="rs-header" className="rs-header style2 header-transparent">
                  ...
                  <div className="topbar-contact">
                    <ul>
                      <li>
                        ...
                        <a href="mailto:info@byldgroup.com">
                          info@byldgroup.com
                        </a>
                      </li>
                      <li>
                  ...
                  <div className="toolbar-sl-share">
                    <ul className="ptt-10">
                      ...
                      <li>
                        <a
                          target="_blank"
                          href="https://www.facebook.com/BYLDExperientialLearning"
                        >
                      ...
                      <li>
                        <a
                          target="_blank"
                          href="https://www.linkedin.com/company/byld-experiential-learning/ "
                        >
                      ...
                      <li>
                        <a
                          target="_blank"
                          href="https://twitter.com/ByldLearnings"
                        >
                      ...
                      <li>
                        <a
                          target="_blank"
                          href="https://www.youtube.com/@BYLDexperientiallearning"
                        >
                      ...
                      <li>
                        <a
                          target="_blank"
                          href="https://instagram.com/byld_experientiallearning?igshid=YmMyMTA2M2Y=/"
                        >
                      ...
                      <nav className="rs-menu hidden-md">
                        <ul className="nav-menu">
                          <li className="menu-item-has-children">
                            ...
                            <ul className="sub-menu">
                              <li className="last-item menu-item-has-children">
                                ...
                                <ul className="sub-menu">
                                  <li>
                                    <a
                                      target="_blank"
                                      href="/eaglesflightindia/"
                                    >
                                      Eagle’s Flight™
                                    </a>
                                  </li>
                                  <li>
                                    <a href="/business-today-simulations">
                                  ...
                                  <li>
                                    <a href="/jenson-8">
                                      Jenson 8 (Virtual Reality Trainings)
                                    </a>
                                  </li>
                                </ul>
                              </li>
                              ...
                              <li className="last-item menu-item-has-children">
                                ...
                                <ul className="sub-menu">
                                  <li>
                                    <a
                                      target="_blank"
                                      href="https://blanchardinternational.co.in/"
                                    >
                                      Blanchard India
                                    </a>
                                  </li>
                                  <li>
                                    <a
                                      target="_blank"
                                      href="/cruciallifechangingskills/"
                                    >
                                      Crucial Life Changing Skills
                                    </a>
                                  </li>
                                  <li>
                                    <a href="/tirian">Tirian</a>
                                  </li>
                                  <li>
                                    <a href="/leadership-and-performance/trapologist">
                                      Trapologist at Work™
                                    </a>
                                  </li>
                                </ul>
                              ...
                              <li className="last-item menu-item-has-children">
                                ...
                                <ul className="sub-menu">
                                  <li>
                                    <a target="_blank" href="/everythingdisc">
                                      Everything DiSC (A Wiley Brand)
                                    </a>{" "}
                                  </li>
                                  <li>
                                    <a target="_blank" href="/fivebehaviors">
                                      Five Behaviors
                                    </a>{" "}
                                  </li>
                                  <li>
                                    <a href="/assessments/lumina-psychometric-assesments">
                                      Lumina Spark
                                    </a>
                                  </li>
                                  <li>
                                    <a href="/assessments/talentsmart-eq-assesments">
                                      TalentSmart EQ
                                    </a>
                                  </li>
                                  <li className="d-none">
                                    <a href="/assessments/assessments-and-development-centers">
                              ...
                              <li className="last-item menu-item-has-children">
                                ...
                                <a href="https://byldcoaching.co.in/">
                                  Coaching
                                </a>
                                {/*<ul className="sub-menu">
                              ...
                              <li className="last-item menu-item-has-children">
                                ...
                                <ul className="sub-menu">
                                  <li>
                                    <a
                                      target="_blank"
                                      href="https://yomabusinesssolutions.com/"
                                    >
                                  ...
                                  <li className="">
                                    <a
                                      target="_blank"
                                      href="https://www.yomatechnologies.in/"
                                    >
                                      YOMA Technologies
                                    </a>
                                  </li>
                              ...
                              <li>
                                <a href="/join-our-partner-network">
                                  Partner Network
                                </a>
                              </li>
                            </ul>
                          ...
                          <li className="menu-item-has-children">
                            ...
                            <ul className="sub-menu">
                              <li>
                                <a href="/press">BYLD Group in News</a>
                              </li>
                              <li>
                                <a href="/events-gallery">Events</a>
                              </li>
                              <li>
                                <a href="/awards-accolades">
                                  Awards & Accolades
                                </a>
                              </li>
                            </ul>
          ...
          <nav className="right_menu_togle hidden-md">
            ...
            <div className="canvas-contact">
              <div className="address-area">
                <div className="address-list">
                  ...
                  <div className="info-content">
                    ...
                    <em>
                      BYLD Group, Plot No. 48, Sector - 44, Opp. EPF Regional
                      Office, Gurugram - 122003, Haryana, India
                    </em>
                  </div>
                </div>
                <div className="address-list">
              ...
              <ul className="social">
                <li>
                  <a target="_blank" href="https://www.facebook.com/BYLDGroup">
                    <i className="fa fa-facebook"></i>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a
                    target="_blank"
                    href="https://www.youtube.com/channel/UC7kOBtc5uLtODiuTYvqgS4g"
                  >
                    <i className="fa fa-youtube"></i>
                  </a>
                </li>
                <li>
                  <a
                    target="_blank"
                    href="https://www.instagram.com/byld_group/"
                  >
                    <i className="fa fa-instagram"></i>
                  </a>
                </li>
            ...
            <ul className="nav-menu">
              <li className="menu-item-has-children">
                ...
                <ul className="sub-menu">
                  <li className="last-item menu-item-has-children">
                    ...
                    <ul className="sub-menu">
                      <li>
                        <a target="_blank" href="/eaglesflightindia/">
                          Eagle’s Flight™
                        </a>
                      </li>
                      <li>
                  ...
                  <li className="last-item menu-item-has-children">
                    ...
                    <ul className="sub-menu">
                      <li>
                        <a target="_blank" href="/blanchardinternational">
                          Blanchard India
                        </a>
                      </li>
                      <li>
                        <a target="_blank" href="/cruciallifechangingskills/">
                          Crucial Life Changing Skills
                        </a>
                      </li>
                      <li>
                  ...
                  <li>
                    <a href="/join-our-partner-network">Partner Network</a>
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li className="menu-item-has-children">
                ...
                <ul className="sub-menu">
                  ...
                  <li>
                    <a href="/awards-accolades">Awards & Accolades</a>
                  </li>
                </ul>
              </li>
              <li>
