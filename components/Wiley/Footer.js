            ...
            <div className="row">
              <div className="col-lg-3 col-md-12 col-sm-12 md-mb-10">
                <div className="footer-logo mb-40">
                  <a href="/">
                    <img
                      src="/wileyassets/img/byld-wiley-auth-logo.png"
                      alt=""
                    />
                  </a>
                </div>
                <div className="textwidget white-color pb-40">
                  <p>
                    ...
                    who are so beguiled and to demo realized by the, so blinded
                ...
                <ul className="footer-social md-mb-30">
                  ...
                  <li>
                    <a
                      href="https://www.youtube.com/channel/UCKn4hSzswvSO6-IqAZC1JtA"
                      target="_blank"
                    >
                      <span>
              ...
              <div className="col-lg-3 col-md-12 col-sm-12 md-mb-10 pl-55 md-pl-15">
                ...
                <ul className="site-map">
                  ...
                  <li>
                    <a href="/wiley/listening-profile">
              ...
              <div className="col-lg-3 col-md-12 col-sm-12 md-mb-10">
                ...
                <ul className="address-widget">
                  ...
                  <li>
                    ...
                    <div className="desc">
                      <a href="mailto:assessments.info@byldgroup.com">
                        assessments.info@byldgroup.com
                      </a>
                    </div>
                  </li>
                  <li>
                    <i className="flaticon-clock-1"></i>
                    <div className="desc">09:30 am - 06:30 pm</div>
                  </li>
                </ul>
              </div>
              ...
              <div className="col-lg-12">
                <div className="copyright text-lg-start text-center ">
                  <p className="text-center">
                    ©2023 By John Wiley & Sons, Inc. The Five Behaviors,
                    Everything DiSC, Everything DiSC Workplace, Everything DiSC
                    Work Of Leaders, Everything 363 For Leaders, Are Trademarks
                    Of John Wiley & Sons, Inc. And Its Affiliated Companies. All
