...
export default function StoryTwo() {
  ...
  const storyTwoSubmitTwo = async event => {
    ...
    try {
      ...
      setTimeout(function () {
        window.open("/edassets/pdf/everything-disc-success-story-sumo-sushi-bento.pdf", "_blank");
      }, 3000);
    } catch (error) {
  ...
  return (
    <>
      ...
      <div className="innervideoshd ebookst">
        <img src='/edassets/img/SuccessStory/everything-disc-success-story-sumo-sushi-bento.png' alt="books" />
        <h4 className='booktitlerow1'>Empowering Leaders with Everything DiSC®</h4>
          ...
          <div className="col-lg-12 md-pt-50">
            <div className="borderall">
              <div className="bannerform formshd">
                ...
                <form id="contact-form" className='clientcornner pbb-20' onSubmit={storyTwoSubmitTwo} >
                  <div className="row">
