...
export default function DiskTTTLP(){
    ...
    const EDttt = async event => {
        ...
        xhttp.open("Post", 'https://byldgroup.in/everythingdisc/wp-json/contact-form-7/v1/contact-forms/17/feedback');
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-6 mb-12">
                                            <select name="slot" required>
                                                ...
                                                <option value="Auguest 17th - 18th, 2023 - DISC Certification (TTT)">Auguest 17th - 18th, 2023 - DISC Certification (TTT)</option>
                                            </select>
                                        </div>
                                        <div className="col-sm-6 mb-12">
