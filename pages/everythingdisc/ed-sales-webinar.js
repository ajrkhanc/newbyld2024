...
export default function EDSalesWorkshop() {
    ...
    return (
        <>
            <Head>
                <title>ED Sales Webinar - Everything DiSC</title>
                ...
                <div className="container-full">
                    <div className="row y-middle">
                        <div className="col-lg-12">
                            <img className="img100" src="/edassets/img/banner/ed-sales-webinar.jpg" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="row rs-vertical-middle">
                        ...
                        <div className="col-lg-6 pr-0">
                            <div className='onlyshd pb-30'>
                                ...
                                Everything DiSC® Sales is a personalized learning experience designed to help sales people successfully create customer-centric interactions that improve results.
                                </p>
                                <p className='mall5'>
                                Attend the Everything DiSC® Sales webinar to learn how to stretch beyond the natural Sales style to more effectively adapt to customers’ preferences and expectations—regardless of the customer’s unique buying style.
                                </p>
                                ...
                                <div className='rs-estimate'>
                                    <ul className="estimate-info mtt-5">
                                        ...
                                        <li>Learn how to Increase Sales effectiveness with power of DiSC®.</li>
                                        <li>Learn to communicate better and improve sales relationships using the power of DiSC®.</li>
                                        <li>Identify and understand customer’s DiSC® buying styles.</li>
                                        <li>Learn to adapt the DiSC® sales to meet customer’s needs.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6 mb-12">
                                                <select name="slot" required>
                                                    ...
                                                    <option value="November 18th 2022, Everything DiSC® Sales Webinar">November 18th 2022, Everything DiSC® Sales Webinar</option>
                                                </select>
                                            </div>
                                            <div className="col-sm-6 mb-12">
