...
export default function BrowseCourses() {
  ...
  const submitF = async (event) => {
    ...
    try {
      ...
      const phone = uniqueId.toString();

      const email = `user_${uniqueId}@dummy.com`;
  ...
  async function logmaintane(
    ...
    try {
      ...
      console.log("YOMA API SUCCESS", data);
    } catch (error) {
      console.log("YOMA API ERROR", error);
    }
  }
  return (
    <>
          ...
          <form onSubmit={submitF}>
            <div className="row">
              ...
              <div className="col-sm-12 mradio">
                <div className="fcol1">
                  <h2>I can recognize my emotions as I experience them.</h2>
                ...
                <div className="fcol1">
                  <h2>
                    I find it hard to name the emotion(s) as I am experiencing
                    them.
                  </h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very often</label>
                ...
                <div className="fcol1">
                  <h2>I know my strengths and weaknesses</h2>
                  <div className="fcolmain">
                    <label className="beafinput">Not at all</label>
                  </div>
                  <div className="fcolmain">
                ...
                <div className="fcol1">
                  <h2>
                    I am aware of time(s) and situations that trigger off
                    reaction(s) in me.
                  </h2>
                ...
                <div className="fcol1">
                  <h2>
                    I ask for feedback from others on what I do well and what
                    can I change
                  </h2>
                  <div className="fcolmain">
                    <label className="beafinput">Not at All</label>
                ...
                <div className="fcol1">
                  <h2>I lose my temper when I feel frustrated</h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
                  </div>
                  <div className="fcolmain">
                ...
                <div className="fcol1">
                  <h2>
                    I find it difficult to engage, when I feel frustrated or
                    unhappy
                  </h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
                ...
                <div className="fcol1">
                  <h2>I often feel, I don’t enjoy my work</h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
                  </div>
                  <div className="fcolmain">
                ...
                <div className="fcol1">
                  <h2>
                    I find it hard to resist the impulse to respond when I feel
                    strong emotions
                  </h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
                ...
                <div className="fcol1">
                  <h2>People have told me that I’m a good listener</h2>
                  <div className="fcolmain">
                    <label className="beafinput">Not at All</label>
                  </div>
                  <div className="fcolmain">
                ...
                <div className="fcol1">
                  <h2>
                    I ask people for feedback on what I do well, and how I can
                    improve
                  </h2>
                  <div className="fcolmain">
                    <label className="beafinput">Not at All</label>
                ...
                <div className="fcol1">
                  <h2>I use active listening skills when people speak to me</h2>
                  <div className="fcolmain">
                    <label className="beafinput">Not at All</label>
                  </div>
                  <div className="fcolmain">
                ...
                <div className="fcol1">
                  <h2>I find it difficult to read other people’s emotions</h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
                  </div>
                  <div className="fcolmain">
                ...
                <div className="fcol1">
                  <h2>
                    I find it hard to spot the mood in the room when things are
                    not going well
                  </h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
                ...
                <div className="fcol1">
                  <h2>
                    I find it hard to get people to share what their real
                    motives are
                  </h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
                ...
                <div className="fcol1">
                  <h2>I avoid conflict and negotiations</h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
                  </div>
                  <div className="fcolmain">
                ...
                <div className="fcol1">
                  <h2>I struggle to build rapport with others</h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
                  </div>
                  <div className="fcolmain">
                ...
                <div className="fcol1">
                  <h2>
                    I find it hard to get everyone onboard with solutions that
                    would satisfy all
                  </h2>
                  <div className="fcolmain">
                    <label className="beafinput">Very Often</label>
