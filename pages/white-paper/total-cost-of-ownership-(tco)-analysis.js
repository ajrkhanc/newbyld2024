...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/V1.0_Total Cost of Ownership (TCO) Analysis.pdf")
                     }, 3000);
    ...
    return(
        <>
          <Head>
            <title>Total cost of Ownership (tco) Analysis</title>
            <meta name="description" content="Total cost of Ownership (tco) Analysis"/> 
          </Head>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Total cost of Ownership (tco) Analysis</h4>
