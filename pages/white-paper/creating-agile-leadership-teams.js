...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/creating-agile-leadership-teams.pdf")
                     }, 3000);
    ...
    return(
        <>
          <Head>
            <title>Creating agile leadership teams</title>
            <meta name="description" content="Creating agile leadership teams"/> 
          </Head>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Creating agile leadership teams</h4>
