...
export default function Home() {
        ...
        xhr.onreadystatechange = function () {
            ...
            if (xhr.status == 200) {
                ...
                window.setTimeout(function () {
                    window.location.href = `/fivebehaviors/assessment/gtd-assessment-m/${newnameurl}`
                }, 1000);
    ...
    return (
        ...
        <link rel="canonical" href="https://byldgroup.com/fivebehaviors/assessment/gtd-assessment-m" />
...
{/* 
            <button onClick={() => setModalOpen7(!modalOpen7)} id="myButton" style={{ display: "none" }}>
                    modalevent
                  </button> */}
