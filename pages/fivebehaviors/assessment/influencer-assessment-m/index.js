...
export default function BrowseCourses() {
    ...
    xhr.onreadystatechange = function () {
      ...
      if (xhr.status == 200) {
        ...
        window.setTimeout(function () {
          window.location.href = `/fivebehaviors/assessment/influencer-assessment-m/${newnameurl}`
        }, 1000);
  ...
  return (
    ...
    <link rel="canonical" href="https://byldgroup.com/fivebehaviors/assessment/influencer-assessment-m" />
