        ...
        xhr.onreadystatechange = function () {
          ...
          if (xhr.status == 200) {
            ...
            window.setTimeout(function () {
              window.location.href = `/fivebehaviors/assessment/style-under-stress-assessment/${newnameurl}`
            }, 1000);
          ...
          var xhttp = new XMLHttpRequest();
            ...
            xhttp.open("Post", 'https://ajrkhan.xyz/everythingdisc/wp-json/contact-form-7/v1/contact-forms/76/feedbackk');
