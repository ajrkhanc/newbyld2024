...
export default function StoryONe() {
  ...
  const storyOneSubmitOne = async event => {
    ...
    try {
      ...
      setTimeout(function () {
        window.open("/5bassets/pdf/5b-successstory-totalconstruction.pdf", "_blank");
      }, 3000);
    } catch (error) {
  ...
  return (
    <>
      ...
      <div className="innervideoshd ebookst">
        <img src='/5bassets/img/5b-successstory-totalconstruction.png' alt="books" />
        <h4 className='booktitlerow1'  style={{
                                    ...
                                    fontSize: '20px',
                                    lineHeight: '30px'
                                }}>Driving The Bottom Line With TeamWork </h4>
