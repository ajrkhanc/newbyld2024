...
export async function getServerSideProps(context) {
    const post5 = await fetch('https://fivebehaviorsblog.vercel.app/api/posts')
    ...
    const res = await fetch(`https://fivebehaviorsblog.vercel.app/api/post/${posturl}`)
    const posts = await res.json()

    const getfeedback = await fetch(`https://fivebehaviorsblog.vercel.app/api/posts/feed/${posturl}`)
    ...
    return (
        <>
            <Head>
                ...
                <link rel="canonical" href={"https://blog.byldgroup.com/fivebehaviors/"+posts.posturl} />
                {/* Twitter */}
