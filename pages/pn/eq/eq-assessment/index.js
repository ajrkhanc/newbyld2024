...
export default function BrowseCourses() {
    ...
    const submitF = async (event) => {
        ...
        const referredby = event.target.referredby.value;
        ...
        const result = `https://byldgroup.com/pn/eq/eq-assessment/${newnameurl}`
        ...
        xhr.onreadystatechange = function () {
            ...
            if (xhr.status == 200) {
                ...
                if (data.status == 0) {
                    var xhttp = xhr;
                    xhttp.open("Post", 'https://ajrkhan.xyz/byldgroup/wp-json/contact-form-7/v1/contact-forms/251/feedback');
                    ...
                    window.setTimeout(function () {
                        window.location.href = `/pn/eq/eq-assessment/${newnameurl}`
                    }, 1000);
                }
                            ...
                            <div className='col-sm-12'>
                                <div className='fcol1 lastinp ptt-20'>
                                    <div className='row inpuut'>
                                        ...
                                        <div className="col-sm-4 mb-12 clientcornner">
                                            <select name="referredby" required>
                                                <option value="">Referred By*</option>
                                                <option value="Sonia Banerjee">Sonia Banerjee</option>
                                                <option value="Dharmendra">Dharmendra</option>
                                                <option value="George Christopher">George Christopher</option>
                                                <option value="Sanjeev Pandey">Sanjeev Pandey</option>
                                                <option value="Sarah Henry">Sarah Henry</option>
                                                <option value="Sunita Rangwani">Sunita Rangwani</option>
                                                <option value="Naina">Naina</option>
                                                <option value="Varun Harnal">Varun Harnal</option>
                                                <option value="Parag Gadhia">Parag Gadhia</option>
                                                <option value="Mark Kaushick">Mark Kaushick</option>
                                                <option value="Swanand Ranade">Swanand Ranade</option>
                                                <option value="Abanibhushan Bera">Abanibhushan Bera</option>
                                                <option value="Abhijeet Desai">Abhijeet Desai</option>
                                                <option value="Apurva Sharma">Apurva Sharma</option>
                                                <option value="Jatin Adlakha">Jatin Adlakha</option>
                                                <option value="Thomas">Thomas</option>
                                                <option value="Amol Sheogaonkar">Amol Sheogaonkar</option>
                                                <option value="Srikanth Govindarajula">Srikanth Govindarajula</option>
                                                <option value="Mohammed Shafi">Mohammed Shafi</option>
                                            </select>
