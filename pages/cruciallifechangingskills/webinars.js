...
export default function Webinars() {
  const WebinarsForm = async (event) => {
    ...
    xhttp.open(
      "Post",
      "https://byldgroup.in/cruciallifechangingskills/wp-json/contact-form-7/v1/contact-forms/12/feedback"
    );
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 contact-title">
              ...
              <p>
                Explore our complimentary webinar series get a quick essence of
                our online trainings. These sessions would help pave the way to
                the future. As there are no regional boundaries to these
                workshops, we thrive to help you manage your people’s
                development amid uncertain times.
              </p>
            </div>
          </div>
        </div>
            ...
            */}
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 7th,August
                    , 2024
                  </h6>
                  <h6>
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  ...
                  <a href="#registered">
                    <button class="register gtdcolor">REGISTER NOW</button>
                  </a>
                </div>
              </div>
            </div>
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 5th
                    ,September - 2024
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3.00 PM to
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  ...
                  <a href="#registered">
                    <button class="register phothemecolor">REGISTER NOW</button>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 4th
                    October , 2024
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3:00 PM -
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 22nd
                    November ,2024
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3:00 PM to
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 6th
                    December, 2024
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3:00 PM -
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 15th
                    January ,2025
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3:00 PM to
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date green-col">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 30th
                    January,2025
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3:00 PM -
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 13th
                    February,2025
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3.00 PM to
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i>28th
                    February ,2025
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3.00 PM to
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 13th March
                    ,2025
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3.00 PM to
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date green-col">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 25th
                    March, 2025
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 3:00 PM -
              ...
              <form id="contactForm" class="row" onSubmit={WebinarsForm}>
                ...
                <div class="col-md-6 col-6">
                  <select name="slot" required>
                    ...
                    <option value="Crucial Conversations for Accountibility-7th ,August - 2024">
                    Crucial Conversations for Accountibility-7th ,August - 2024
                    </option>
                    {/* <option value="Getting Things Done - March 8th, 2024">Getting Things Done - March 8th, 2024</option>*/}

                    <option value="Trapologist At work	-29th,August - 2024">
                        Trapologist At work	-29th,August - 2024
                    </option>
                    {/* <option value="Trapologist At work - 31th May, 2024">Trapologist At work - 31th May, 2024</option>   */}
                    <option value="Crucial Conversations for Mastering Dialogue 5th ,September">
                        Crucial Conversations for Mastering Dialogue 	5th ,September
                    </option>
                    {/* <option value="Influencer - 10th April, 2024">Influencer - 10th April, 2024</option>  */}
                    <option value="The Power of Habit	20th,September - 2024">
                        The Power of Habit	20th,September - 2024
                    </option>
                    <option value="Crucial Influence	4th -October - 2024">
                        Crucial Influence	4th -October - 2024
                    </option>
                    <option value="Getting Things Done 	30th-October - 2024">
                        Getting Things Done 	30th-October - 2024
                    </option>
                    <option value="Trapologist At work -5th -November - 2024">
                        Trapologist At work -5th -November - 2024
                    </option>
                    <option value="Crucial Conversations for Accountibility	22nd November -2024">
                            Crucial Conversations for Accountibility	22nd November - 2024
                    </option>
                    <option value="The Power of Habit	6th - December - 2024">
                        The Power of Habit	6th - December - 2024
                    </option>
                    <option value="Getting Things Done	23rd	December - 2024	">
                            Getting Things Done	23rd	December - 2024	
                    </option>
                    <option value="Trapologist At work	15th January - 2025	">
                        Trapologist At work	15th January - 2025
                    </option>
                    <option value="Crucial Influence	30th January - 2025	">
                        Crucial Influence	30th January - 2025
                    </option>
                    <option value="Crucial Conversations for Mastering Dialogue 13th February - 2025	">
                        Crucial Conversations for Mastering Dialogue 	13th February - 2025
                    </option>
                    <option value="Crucial Conversations for Accountibility	28th February - 2025	">
                            Crucial Conversations for Accountibility	28th February - 2025
                    </option>
                    <option value="Getting Things Done	13th March - 2025">
                        Getting Things Done	13th March - 2025
                    </option>
                    <option value="Crucial Influence 25th March-2025">
                        Crucial Influence 25th March -2025
                    </option>
                  </select>
                </div>
                <div class="col-md-6 col-6">
