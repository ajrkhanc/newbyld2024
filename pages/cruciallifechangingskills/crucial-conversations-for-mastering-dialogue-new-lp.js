...
export default function BrowseCourses() {
  const WorkshopsForm = async (event) => {
    ...
    xhttp.open(
      "Post",
      "https://byldgroup.in/cruciallifechangingskills/wp-json/contact-form-7/v1/contact-forms/21/feedback"
    );
  ...
  return (
    <>
      <Head>
        <title>
          Crucial Conversations for Mastering Dialogue New LP - Crucial
          Life-Changing Skills
        </title>
        <meta
          name="description"
          content="Whenever you get into any high-stake discussion with your boss, do you get into permanent silence of violence? REGISTER TODAY! Please express your interest and our sales consultant will get... Read more"
        />
        <link
          rel="stylesheet"
          type="text/css"
          ...
          <div className="row y-middle">
            <div className="col-md-6 text-center">
              ...
              <p className="genericp">
                ...
                dialogues in a conversation which marks an indicator of
        ...
        <div className="container">
          <div className="row workshop-form">
            <div className="col-sm-6">
              <div>
                <p>
                  Learn the nine powerful skills to obtain results with clear
                  and effective dialogues for you to work through disagreements.
                  Learn to make crucial conversations for lasting improvement.
                </p>
            ...
            {/* <div class="col-md-4 workshop-col">
                            <div class="row workshop-row">
                                ...
                                <div class="col-md-12 workshop-date">
                                    <h6><i class="fa fa-calendar" aria-hidden="true"></i> September 13th - 14th, 2023</h6>
          ...
          {/*  <div class="col-md-4 workshop-col">
            ...
            {/* <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i> 21st
                    December, 2023
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 10:00 AM to
             ...
             {/*<div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i>8th March
                    , 2024
                  </h6>
                  <h6>
            ...
            <div class="col-md-4 workshop-col">
              <div class="row workshop-row">
                ...
                <div class="col-md-12 workshop-date">
                  <h6>
                    <i class="fa fa-calendar" aria-hidden="true"></i>18th & 19th April
                  </h6>
                  <h6>
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 9:00 AM - 5:30 PM
                  </h6>
                  <a href="#registered">
                    <button class="register">REGISTER NOW</button>
                  </a>
