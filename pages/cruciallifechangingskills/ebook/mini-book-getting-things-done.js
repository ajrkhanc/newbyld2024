...
export default function Ebook(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/mini-book-getting-things-done.pdf")
                     }, 3000);
    ...
    return(
        <>
        <Head>
            <title>Getting Things Done the art of stress free productivity - Crucial Life-Changing Skills</title>
        <link rel="canonical" href="https://byldgroup.com/cruciallifechangingskills/ebook/mini-book-getting-things-done" />
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
                        <h1>Getting Things Done the art of stress free productivity</h1>
                        
                        <p className='colorb'>
                        In this booklet, you’ll preview the powerful concepts that elevated the book to the New York Times bestseller list and the GTD<sup>®</sup> <br></br>methodology to one of the most popular productivity solutions out there.
                        </p>
              ...
              <div className='row workshop-form'>
                ...
                <form id="contactForm" class="row formb" onSubmit={EbookForm}>
                        ...
                        <div className="col-sm-12 mb-12 d-none">
                           <input type="checkbox" name="ebookname" value="Getting Things Done the art of stress free productivity"/> 
                        </div>   
