...
export default function Ebook(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/research-10x-your-influence.pdf", "_blank")
                     }, 3000);
    ...
    return(
        <>
        <Head>
            <title>Research 10X Your Influence - Crucial Life-Changing Skills</title>
        <link rel="canonical" href="https://byldgroup.com/cruciallifechangingskills/ebook/research-10x-your-influence" />
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
                        <h1>Research 10X Your Influence</h1>
                        <h6 className='colorb'>OUR SERIOUS PROBLEMS ARE ROOTED IN HUMAN BEHAVIOR</h6>                        
                        <p className='colorb'>
              ...
              <div className='row workshop-form'>
                ...
                <form id="contactForm" class="row formb" onSubmit={EbookForm}>
                        ...
                        <div className="col-sm-12 mb-12 d-none">
                           <input type="checkbox" name="ebookname" value="Research 10X Your Influence"/> 
                        </div>   
