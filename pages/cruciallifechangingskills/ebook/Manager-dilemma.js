  ...
  const EbookForm = async (event) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setTimeout(() => {
          window.open("/classets/pdf/A-manager-delima.pdf", "_blank");
        }, 3000);
      } else {
        alert("There was a problem with the request.");
      }
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
              <h1>A Manager &apos;s Dilemma</h1>

              <p className="colorb">
                SKILLS TO LEAD WITH EMPATHY AND ACCOUNTABILITY . . .
              </p>

              <p className="colorb">
                These are not hypotheticals. They’re real-life stories of
                leaders navigating real-life situations. Today, leadership
                demands more than operational skill—it demands a human touch,
                one that acknowledges people’s challenges and still ensures the
                work gets done.
              </p>
            </div>
          </div>
