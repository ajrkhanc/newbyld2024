  ...
  const EbookForm = async (event) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setTimeout(() => {
          window.open(
            "/classets/pdf/eBook-Leadership Confessions1.pdf",
            "_blank"
          );
        }, 3000);
      } else {
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
              <h1>Leadership Confessions</h1>

              <p className="colorb">
                ACCOUNTABILITY SKILLS TO SET NEW LEADERS UP FOR SUCCESS . . .
              </p>

              <p className="colorb">
                And no wonder—most people find themselves in a leadership role
                because they performed well in their previous position or had
                strong technical skills, not because they were experienced
                leaders or even exemplified traditional leadership traits.
              </p>
            </div>
          </div>
        </div>
