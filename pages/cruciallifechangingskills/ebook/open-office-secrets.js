...
export default function Ebook(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/open-office-secrets.pdf", "_blank")
                     }, 3000);
    ...
    return(
        <>
        <Head>
            <title>Open Office Secrets - Crucial Life-Changing Skills</title>
        <link rel="canonical" href="https://byldgroup.com/cruciallifechangingskills/ebook/open-office-secrets" />
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
                        <h1>Open Office Secrets</h1>
                        
                        <p className='colorb'>
                        WHY EMPLOYEES FEAR GIVING FEEDBACK TO THEIR MANAGER & FOUR TIPS TO HELP PEOPLE AT EVERY LEVEL SPEAK UP
                        </p>
              ...
              <div className='row workshop-form'>
                ...
                <form id="contactForm" class="row formb" onSubmit={EbookForm}>
                        ...
                        <div className="col-sm-12 mb-12 d-none">
                           <input type="checkbox" name="ebookname" value="Open Office Secrets"/> 
                        </div>   
