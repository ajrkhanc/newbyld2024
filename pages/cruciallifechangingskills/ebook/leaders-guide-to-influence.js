        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/leaders-guide-to-influence.pdf", "_blank")
                     }, 3000);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
                        <h1>A Leaders Guide to Influence</h1>                        
                        <p className='colorb'>
                        The problems every leader must solve are twofold. First are the strategy problems: What are the initiatives and goals we want to accomplish? What are our plans? How are we going to spend our time?
                        </p>
                        <p className='colorb'>
                        The second problem of leadership, however, is even more important and usually much tougher to solve: How do we get humans to act on these initiatives, goals, and plans? You can come up with brilliant strategies and well-thought-out plans, but how do you actually get the human beings that work with you to execute effectively?
                        </p>
                    </div>
              ...
              <div className='row workshop-form'>
                ...
                <form id="contactForm" class="row formb" onSubmit={EbookForm}>
                        ...
                        <div className="col-sm-12 mb-12 d-none">
                           <input type="checkbox" name="ebookname" value="Leaders Guide to Influence"/> 
                        </div>   
