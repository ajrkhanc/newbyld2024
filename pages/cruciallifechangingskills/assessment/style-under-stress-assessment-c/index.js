        ...
        xhr.onreadystatechange = function () {
          ...
          if (xhr.status == 200) {
            ...
            window.setTimeout(function () {
              window.location.href = `/cruciallifechangingskills/assessment/style-under-stress-assessment-c/${newnameurl}`
            }, 1000);
          ...
          var xhttp = new XMLHttpRequest();
            ...
            xhttp.open("Post", 'https://byldgroup.in/cruciallifechangingskills/wp-json/contact-form-7/v1/contact-forms/176/feedback');
