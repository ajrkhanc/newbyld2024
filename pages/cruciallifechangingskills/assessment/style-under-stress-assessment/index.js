          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              ...
              <p>
                ...
                we all struggle to stay cool. We often either clam up and hope
                the conflict will go away, or we blow up and damage trust and
                respect. Take the assessment and find out how well you
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <div>
                ...
                <p>
                  Before you begin, think of a relationship you want to
                  explore—with your boss, coworker, direct report, partner, or
                  family member.
                </p>
                <h5>Identify a Circumstance</h5>
                <p>
                  Next, think of a tough disagreement you've had or continue to
                  have—one where you feel frustrated or irritated or that
                  doesn't get resolved to your satisfaction.
                </p>
                <h5>Apply</h5>
                <p>
                  With the relationship and disagreement in mind, respond to the
            ...
            <div className="col-md-6">
              <form onSubmit={submitF}>
                <div className="formsbarassesment">
                  <ol>
                    <li>
                      Rather than tell people exactly what I think, sometimes I
                      rely on jokes, sarcasm, or snide remarks to let them know
                      I'm frustrated.
                    </li>
                    <div>
                      <span>
                      ...
                      <span>
                        <input
                          ...
                          tabindex="2"
                        />
                        <label for="1f">False</label>
                      </span>
                    </div>
                    <li>
                      When I've got something tough to bring up, I understate it
                      rather than share my full opinion.
                    </li>
                    <div>
                      <span>
                        <input
                      ...
                      <span>
                        <input
                          ...
                          tabindex="4"
                        />
                        <label for="2f">False</label>
                      </span>
                    </div>
                    <li>
                      Sometimes when people bring up a touchy issue, I try to
                      change the subject.
                    </li>
                    <div>
                      <span>
                      ...
                      <span>
                        <input
                          ...
                          tabindex="6"
                        />
                        <label for="3f">False</label>
                      </span>
                    </div>
                    <li>
                      When it comes to dealing with difficult subjects,
                      sometimes I steer the conversation to safer issues rather
                      than address what really concerns me.
                    </li>
                    <div>
                      <span>
                        <input
                    ...
                    <div>
                      ...
                      <span>
                        <input
                          ...
                          tabindex="10"
                        />
                        <label for="5f">False</label>
                      </span>
                    </div>
                    <li>
                      I put off getting back to people sometimes because I'm
                    ...
                    <li>
                      I sometimes find myself having the same conversation with
                    ...
                    <div>
                      ...
                      <span>
                        <input
                          ...
                          tabindex="26"
                        />
                        <label for="13f">False</label>
                      </span>
                    </div>
                    <li>
                      At times I walk away from conversations with an agreement
                      that I don't think really solves the problem.
                    </li>
                    <div>
                      <span>
                        <input
                      ...
                      <span>
                        <input
                          ...
                          tabindex="28"
                        />
                        <label for="14f">False</label>
                      </span>
                    </div>
                    <li>
                      When I'm discussing an important topic with others,
                      sometimes I move from trying to make my point to trying to
                      win the battle.
                    </li>
                    <div>
                      <span>
                      ...
                      <span>
                        <input
                          ...
                          tabindex="30"
                        />
                        <label for="15f">False</label>
                      </span>
                    </div>
                    <li>
                      Sometimes I decide that it's better to keep the peace than
                      share my views.
                    </li>
                    <div>
                      <span>
                      ...
                      <span>
                        <input
                          ...
                          tabindex="32"
                        />
                        <label for="16f">False</label>
                      </span>
                    </div>
                    <li>
                      When talking about sensitive subjects, my emotions often
                      get the best of me.
                    </li>
                    <div>
                      <span>
                      ...
                      <span>
                        <input
                          ...
                          tabindex="34"
                        />
                        <label for="17f">False</label>
                      </span>
                    </div>
                    <li>
                      I sometimes walk away from conversations rehashing the
                      reasons I'm right and others are wrong.
                    </li>
                    <div>
                      <span>
                        <input
