  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="The GTD Assessment is a twenty-question quiz that helps reveal some of your tendencies with managing workflow. See what you know and what you need to improve on."
        />
      </Head>
            ...
            <div className="col-md-6">
              <div>
                ...
                <p>
                  ...
                  move toward silence (masking, avoiding, or withdrawing) or
                  verbal violence (controlling, labeling, or attacking) during a
                  Crucial Conversation. The higher your score in this section,
                  the more likely you are to move to silence and/or violence.
                  Notice which behaviors you resort to in crucial moments.
                </p>
                <p>
                  Your Dialogue Skills Score indicates how well you use the
                  skills taught in Crucial Conversations. The higher your score
                  in this section, the better you are at using the skills. You
                  should pay special attention to any section in which you score
                  zero.
                </p>
                <p>
                  Awareness is the first step toward improvement. Action is the
                  next step. Improve your communication and your results with
                  the skills from Crucial Conversations.
                </p>
              </div>
            </div>
            <div className="col-md-6">
                ...
                {result.slice(0, 1).map((results) => {
                  ...
                  return (
                    <div class="recent-post-widget paddi20" id="demo">
                      <div
                        class="component-wrapper assessment"
                        id="gtd-results"
                      >
                        <div class="component-content">
                          <div class="assessment-right">
                            ...
                            <div class="assessment-result-block">
                              ...
                              <div>
                                <br></br>
                                <h4>Verbal Violence Score Breakdown</h4>
                                <ul>
                            ...
                            <div class="assessment-result-block">
                              ...
                              <p>
                                Now look at how well you use the Crucial
                                Conversations skills. If you scored one or two,
                                you're doing alright in this area—at least in
                                the scenario you had in mind when answering the
                                questions. If you scored zero, you should pay
                                special attention to the corresponding chapter
                                in the book—or attend a course.
                              </p>
                              <div>
                                <ul>
