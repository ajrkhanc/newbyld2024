...
export default function BrowseCourses() {
    ...
    const submitF = async (event) => {
        ...
        xhr.onreadystatechange = function () {
            ...
            if (xhr.status == 200) {
                ...
                window.setTimeout(function () {
                    window.location.href = `/cruciallifechangingskills/assessment/what-would-you-do-assessment-m/${newnameurl}`
                }, 1000);
        ...
        xhttp.open("Post", 'https://byldgroup.in/cruciallifechangingskills/wp-json/contact-form-7/v1/contact-forms/89/feedback');
