            ...
            <div class="row">
              <div class="col-lg-12 contact-title">
                <div className='clLogoBox'>
                  <img
                    src="/classets/img/CrucialConversationsLogo.webp"
                    alt="image1"
                    loading="lazy"
                  />
                  <p>
              ...
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    <h5>GET UNSTUCK</h5>
                    <p>
                      Identify obstacles to solve dilemmas that contribute to
                      poor results and struggling relationships.
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    ...
                    <p>
                      Staying calm when feeling angry or defensive and
                      identifying stories that you might tell yourself.{" "}
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    ...
                    <p>
                      Start with making things clear to yourself and others
                      about what you really want with Crucial Conversations
                      train the trainer.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    ...
                    <p>
                      Be mindful of the warning signs that show when the
                      dialogue is at safety or at risk.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    ...
                    <p>
                      Effectively listen and respond to the feedback and
                      concerns of others.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    ...
                    <p>
                      Make every Crucial Conversation change its course to
                      better outcomes. Unlock professional communication skills.
                    </p>
                  </div>
                </div>
              </div>
