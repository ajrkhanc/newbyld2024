...
export default function Gettingthingsdone() {
    ...
    return (
        <>
            <Head>
                <title>The Power of Habit LP - Crucial Life-Changing Skills</title>
                <meta name="description" content="The Power of Habit LP - Crucial Life-Changing Skills" />
                <link rel="stylesheet" type="text/css" charset="UTF-8" href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick.min.css" /> 
            <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick-theme.min.css" />
            </Head>
            <section>
                <iframe width="100%" height="660" src="https://www.youtube.com/embed/Jqg8z3uUfoc?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </section>
            <section class="gtdlpsecondrow">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 contact-title">
                            <h1 className='text-left'>Unlock Your Full Potential for a Better You with The Power of Habit</h1>
                            <p className='text-left'>
                            Make the necessary change in your behavior and habits to achieve extraordinary professional results.
                            </p>
                            <p className='text-left'>
                            Learn how your habits work and cultivate productive ones for a complete transformation. This course will help you gain mastery over your habits and control your behavior for effective decision-making, success, and desired results. The Power of Habit program will further help you
                            </p>
                            ...
                            <ul className='browsecourseullist'>
                                ...
                                <li>
                                    <i class="fa fa-chevron-left"></i>
                                    Become highly productive and a lot more.
                                </li>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-6 alicc'>
                            <img className='lim' src='/classets/img/ThePowerofHabit.svg' />
                            ...
                            <form id="contactForm" class="row fbd">
                                ...
                                <div class="col-md-12">
                                    <select name='slot' required>
                                        ...
                                        <option value="The Power of Habit – February 15th, 2023 - Webinar">The Power of Habit – February 15th, 2023 - Webinar</option>
                                        <option value="The Power of Habit - February 17th, 2023 - Workshop">The Power of Habit - February 17th, 2023 - Workshop</option>
                                    </select>
                                </div>
