...
export default function Gettingthingsdone() {
    return (
      <>
        <Head>
          <title>
            Getting Things Done Online Course | GTD Training & Method
          </title>
            ...
            <div class="row">
              <div class="col-lg-12 contact-title">
                ...
                <p>
                  ...
                  experience and peak performance with Getting Things Done.
                </p>
                <h6>
                  <a
                    class="submit"
                    target="_blank"
                    href="/classets/pdf/course-overview-getting-things-done.pdf"
                  >
                    {" "}
              ...
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    <h5>ENGAGE</h5>
                    <p>
                      Use your system to take appropriate action with
                      confidence.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    <h5>REVIEW</h5>
                    <p>
                      Make time each week to conduct a formal review of your
                      tasks and goals.
                    </p>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-lg-6 left-about-area preview-course">
                ...
                <p>
                  ...
                  to bring the course to your organization.
                </p>
                <hr />
                <h6>
