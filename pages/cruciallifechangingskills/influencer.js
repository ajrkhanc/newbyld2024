            ...
            <div className="row">
              ...
              <div className="col-sm-4">
                <div className="incbox">
                  ...
                  <p>
                    Formerly Influencer, Crucial Influence teaches leaders how
                    to apply the Six Sources of Influence to create lasting
                    behavior change. See what’s new.
                  </p>
                  <a
            ...
            <div className="row">
              ...
              <div className="col-sm-5">
                ...
                <p className="font24 pabb-20 text-justify">
                  ...
                  sources that shape behavior and teaches a method for using
                  these sources to influence people and results.
                </p>
              </div>
              ...
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    ...
                    <p>
                      Learn the root cause of the persisting problems which
              ...
              <div class="col-md-4">
                <div class="row feature-right">
                  ...
                  <div class="col-md-10 feature-content">
                    ...
                    <p>
                      Make the ostensible, unmanageable, and undesirable
                      behaviors manageable and enjoyable.
                    </p>
                  </div>
                </div>
              </div>
