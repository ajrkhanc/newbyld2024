  ...
  return (
    <>
      <Head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=AW-876781539"
        ></script>
        {/* <script
      ...
      <div className="container pbb-40">
        <div className="row">
          <div className="col-md-4">
            <a
              href="https://www.facebook.com/Cruciallifechangingskills"
              target="_blank"
            >
          ...
          <div className="col-md-4">
            <a
              href="https://www.linkedin.com/company/crucial-life-changing-skills/"
              target="_blank"
            >
              <div className="innerboxthankyou">
