...
export default function Courseoverviewcrucialconversationsformasteringdialogue(){
    ...
    const ContactUsForm = async event => {
        ...
        xhttp.open("Post", 'https://byldgroup.in/cruciallifechangingskills/wp-json/contact-form-7/v1/contact-forms/10/feedback');
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/course-overview-pdf-influencer.pdf", "_blank")
                     }, 3000);
