...
export default function Courseoverviewcrucialconversationsformasteringdialogue(){
    ...
    const ContactUsForm = async event => {
        ...
        xhttp.open("Post", 'https://byldgroup.in/cruciallifechangingskills/wp-json/contact-form-7/v1/contact-forms/9/feedback');
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/course-overview-pdf-crucial-conversations-for-mastering-dialogue.pdf", "_blank")
                     }, 3000);
    ...
    return(
        ...
        <link rel="canonical" href="https://byldgroup.com/cruciallifechangingskills/course-overview-crucial-conversations-for-mastering-dialogue" />
