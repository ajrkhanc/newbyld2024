...
export default function Courseoverviewcrucialconversationsformasteringdialogue(){
    ...
    const ContactUsForm = async event => {
        ...
        xhttp.open("Post", 'https://byldgroup.in/cruciallifechangingskills/wp-json/contact-form-7/v1/contact-forms/11/feedback');
    ...
    return(
        ...
        <link rel="canonical" href="https://byldgroup.com/cruciallifechangingskills/course-overview-the-power-of-habit" />
