        ...
        if (res.status == "mail_sent") {
          ...
          window.setTimeout(function () {
            window.location.href =
              "/kbassets/pdf/Blanchard Five Drivers of Learning Impact POV MK1316.pdf";
          }, 3000);
        } else {
          document.getElementById("showlabel").innerHTML =
              ...
              <div className="what-did-content">
                <div className="section-title pt-20">
                  ...
                  <p className="text-justify">
                    Organizations invest billions of dollars each year on
                    training initiatives, with the goal of fueling growth and
                    improving organizational vitality. However, training won’t
                    make a difference if learners don’t apply their newly
                    acquired knowledge and skills.
                  </p>
                  <p>
                    In this Blanchard point-of-view eBook you’ll explore five
                    drivers that must be in place to ensure the greatest level
                    of traction with learners and measurable performance
                    outcomes from learning and development initiatives.
                  </p>
                </div>
              </div>
            </div>
