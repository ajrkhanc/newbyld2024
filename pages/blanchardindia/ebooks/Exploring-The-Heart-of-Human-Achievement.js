        ...
        if (res.status == "mail_sent") {
          ...
          window.setTimeout(function () {
            window.location.href =
              "/kbassets/pdf/Exploring The Heart of Human Achievement POV MK1319.pdf";
          }, 3000);
        } else {
          document.getElementById("showlabel").innerHTML =
              ...
              <div className="what-did-content">
                <div className="section-title pt-20">
                  <h2 className="titleh2">
                    Exploring The Heart of Human Achievement{" "}
                  </h2>

                  <p className="text-justify">
                    At Blanchard®, The Heart of Human Achievement™ isn’t just a
                    tagline; it’s a commitment to one of the most fundamental
                    yet critical human skills needed in today’s
