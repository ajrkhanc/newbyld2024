...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/critical-skills-every-sales-manager-needs.pdf")
                     }, 3000);
    ...
    return(
        <>
          <Head>
            <title>Meeting the Quota Challenge: Critical Skills Every Sales Manager Needs to Excel - BYLD Group</title>
            <meta name="description" content="Meeting the Quota Challenge: Critical Skills Every Sales Manager Needs to Excel"/> 
          </Head>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Meeting the Quota Challenge: Critical Skills Every Sales Manager Needs to Excel</h4>
