            ...
            <div className="col-sm-4">
              <div className="innervideoshd ebookst text-center">
                <a href="/ebook/critical-skills-every-sales-manager-needs">
                  <img
                    src="/assets/img/ebook/critical-skills-every-sales-manager-needs.webp"
                    alt="books"
                  />
                  <h4 className="">
                    Meeting the Quota Challenge: Critical Skills Every Sales
                    Manager Needs to Excel
                  </h4>
            ...
            <div className="col-sm-4">
              <div className="innervideoshd ebookst text-center">
                <a href="/ebook/2023-hr-and-trends">
                  ...
                  <h4 className="">2026 HR and L&D Trends</h4>
                  <h3 className="ebookbtn">Read E-book</h3>
                </a>
              </div>
            </div>
            ...
            <div className="col-sm-4">
              <div className="innervideoshd ebookst text-center">
                <a href="/ebook/inout-creating-coaching-culture">
                  <img
                    src="/assets/img/ebook/inout-creating-coaching-culture.webp"
                    alt="books"
                  />
