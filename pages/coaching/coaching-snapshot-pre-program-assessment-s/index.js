  ...
  return (
    <>
      <Head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-H4RT5QHB12"
        ></script>
        <script
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-12 text-center">
              ...
              <p>
                Select the number that best represents the extent to which you
                do the following (Use the line chart below as a guide.):
              </p>
          ...
          <form onSubmit={submitF}>
            <div className="row">
              ...
              <div className="col-sm-12">
                <div className="fcol1">
                  <h2>
                    1. I create a safe environment for talking about sensitive
                    or personal topics
                  </h2>
                ...
                <div className="fcol1">
                  <h2>
                    2. I keep the conversation focused on the agenda of the
                    other person
                  </h2>
                  <div className="fcolmain">
                    <input
                ...
                <div className="fcol1">
                  <h2>3. I communicate openly and honestly at all times</h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                      name="trust3"
                ...
                <div className="fcol1">
                  <h2>
                    4. My commitments relating to each coaching conversation are
                    always made clear to the other person
                  </h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                ...
                <div className="fcol1">
                  <h2>5. I consistently follow through on my commitments</h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                      name="trust5"
              ...
              <div className="col-sm-12">
                <div className="fcol1">
                  <h2>6. I make it clear when commitments can't be met</h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                      name="ec1"
                ...
                <div className="fcol1">
                  <h2>7. I set a clear goal for every coaching conversation</h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                      name="ec2"
                ...
                <div className="fcol1">
                  <h2>
                    8. I keep every coaching conversation focused on achieving
                    agreed-upon goals
                  </h2>
                  <div className="fcolmain">
                    <input
                ...
                <div className="fcol1">
                  <h2>
                    9. I help others think of alternative ways to view a problem
                    or solution
                  </h2>
                  <div className="fcolmain">
                    <input
                ...
                <div className="fcol1">
                  <h2>
                    10. I help others think of as many ideas or options as they
                    can to solve a problem
                  </h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                ...
                <div className="fcol1">
                  <h2>
                    11. I listen to new ideas without jumping in to judge or
                    evaluate them too soon
                  </h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                ...
                <div className="fcol1">
                  <h2>12. I stay objective during coaching conversations</h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                      name="ec7"
                ...
                <div className="fcol1">
                  <h2>
                    13. I communicate in a way that makes others want to share
                ...
                <div className="fcol1">
                  <h2>
                    14. I help others draw their conclusions when considering
                ...
                <div className="fcol1">
                  <h2>
                    15. I demonstrate understanding by reflecting on or
                ...
                <div className="fcol1">
                  <h2>
                    16. My body language shows a high level of engagement in
                    each conversation
                  </h2>
                  <div className="fcolmain">
                    <input
                ...
                <div className="fcol1">
                  <h2>17. I spend more time listening and less time talking</h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                      name="ec12"
                ...
                <div className="fcol1">
                  <h2>18. I ask helpful questions during conversations</h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                      name="ec13"
                ...
                <div className="fcol1">
                  <h2>19. I am willing to ask tough questions when needed</h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                      name="ec14"
              ...
              <div className="col-sm-12">
                <div className="fcol1">
                  <h2>
                    20. I always end a coaching conversation by clarifying
                ...
                <div className="fcol1">
                  <h2>
                    21. I support others in setting specific dates for follow-up
                ...
                <div className="fcol1">
                  <h2>
                    22. I help others set priorities based on our organization’s
                    needs
                  </h2>
                  <div className="fcolmain">
                    <input
                ...
                <div className="fcol1">
                  <h2>
                    23. I make a clear link between our coaching conversations
                ...
                <div className="fcol1">
                  <h2>
                    24. I provide the coaching others need to grow in their
                    career
                  </h2>
                  <div className="fcolmain">
                    <input
                ...
                <div className="fcol1">
                  <h2>
                    25. Others achieve better results because of the coaching
                    they get from me
                  </h2>
                  <div className="fcolmain">
                    <input
              ...
              <div className="col-sm-12">
                <div className="fcol1">
                  <h2>
                    26. I regularly make time to help others explore career
                    growth challenges
                  </h2>
                  <div className="fcolmain">
                    <input
                ...
                <div className="fcol1">
                  <h2>29. I remind others of the commitments they have made</h2>
                  <div className="fcolmain">
                    <input
                      type="radio"
                      name="cr4"
                ...
                <div className="fcol1">
                  <h2>
                    30. I encourage others to take responsibility for their
                    development
                  </h2>
                  <div className="fcolmain">
                    <input
