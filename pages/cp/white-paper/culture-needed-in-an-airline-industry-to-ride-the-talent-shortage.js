...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/culture-needed-in-an-airline-Industry-to-ride-the-talent-shortage.pdf")
                     });
    ...
    return(
        <>
          <Head>
            <title>Culture Needed in an airline industry to ride the talent shortage</title>
            <meta name="description" content="Culture Needed in an airline industry to ride the talent shortage"/> 
          </Head>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Culture Needed in an airline industry to ride the talent shortage</h4>
                            ...
                            <form id="contact-form" className='clientcornner pbb-10' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="Culture Needed in an airline industry to ride the talent shortage"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
