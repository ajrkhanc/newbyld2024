...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/cppdf/what-will-spur-bfsi-industry.pdf")
                     });
    ...
    return(
        <>
          <Head>
            <title>Embracing the Wave of Growth in the BFSI Industry: Is Your Organization Ready?</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Embracing the Wave of Growth in the BFSI Industry: Is Your Organization Ready?</h4>
                            ...
                            <form id="contact-form" className='clientcornner pbb-10' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="What will spur BFSI industry"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
