...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/embracing-a-customer-centric-mindset.pdf")
                     });
    ...
    return(
        <>
          <Head>
            <title>Embracing a customer centric mindset</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Embracing a Customer-Centric Mindset</h4>
                            ...
                            <form id="contact-form" className='clientcornner pbb-10' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="Embracing a Customer-Centric Mindset"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
