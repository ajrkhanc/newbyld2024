        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/cppdf/challenges-and-recommendations-for-auto-industry-amar-sir.pdf")
                     });
                            ...
                            <form id="contact-form" className='clientcornner pbb-10' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="Challenges and recommendations for AUTO industry"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
