...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/fostering-culture-of-high-performance.pdf")
                     });
    ...
    return(
        <>
          <Head>
            <title>Fostering culture of High Performance</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Fostering culture of High Performance</h4>
            ...
            <div className="container">
                <div className="row rs-vertical-middle">                    
                    <div className="col-lg-6 pr-0">
                        ...
                        <img src="/assets/img/white-paper/fostering-culture-of-high-performance.jpg" />
                        </div>
                    </div>
                            ...
                            <form id="contact-form" className='clientcornner pbb-10' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="Fostering culture of High Performance"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
