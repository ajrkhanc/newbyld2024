...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/pharmaceutical-sector.pdf")
                     });
    ...
    return(
        <>
          <Head>
            <title>BYLD Group - Pharmaceutical Sector</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Pharmaceutical Sector</h4>
            ...
            <div className="container">
                <div className="row rs-vertical-middle">                    
                    <div className="col-lg-6 pr-0">
                        ...
                        <img src="/assets/img/white-paper/pharmaceutical-sector.jpg" />
                        </div>
                    </div>
                            ...
                            <form id="contact-form" className='clientcornner pbb-10' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="Pharmaceutical Sector"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
