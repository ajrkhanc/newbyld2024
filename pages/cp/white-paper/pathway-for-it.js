...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/cppdf/pathway-for-it.pdf")
                     });
    ...
    return(
        <>
          <Head>
            <title>Navigating the Pathway: Opportunities for IT Professionals Amidst Layoffs</title>
            <meta name="description" content="Pathway For IT Professionals In The Wake of Large Scale Layoffs"/> 
          </Head>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Navigating the Pathway: Opportunities for IT Professionals Amidst Layoffs</h4>
                            ...
                            <form id="contact-form" className='clientcornner pbb-10' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="Pathway For IT Professionals In The Wake of Large Scale Layoffs"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
