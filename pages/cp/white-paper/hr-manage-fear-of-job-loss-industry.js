...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/hr-manage-fear-of-job-loss-among-employees-given-the-lay-off-culture-prevalent-in-it-industry-currently.pdf")
                     });
    ...
    return(
        <>
          <Head>
            <title>HR Manage fear of job loss Industry</title>
            <meta name="description" content="HR Manage fear of job loss Industry"/> 
          </Head>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">HR Manage fear of job loss Industry</h4>
                            ...
                            <form id="contact-form" className='clientcornner pbb-10' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="HR Manage fear of job loss Industry"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
