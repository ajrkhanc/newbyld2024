...
export default function Ebookpage(){
    ...
    return(
        <>
          <Head>
            <title>Innovation Race Book Summary - TIRIAN</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Innovation Race Book Summary</h4>
            ...
            <div className="container">
                <div className="row rs-vertical-middle">                    
                    <div className="col-lg-6 pr-0">
                        ...
                        <h4 className="countertoph2 text-left font24">BOOK SUMMARY</h4>
                        <p className='mall5'>
                        The Innovation Race whips around the world to the 7 continents to learn about the current state of innovation. This involves looking for common threads in experiences in innovation from different countries, companies and cultures, to see if we can find some solutions on how to survive. In business-speak this translates into reviewing the challenges and best practices.
                        <br></br>
                        </p>                        
                    ...
                    <div className="col-lg-6 md-pt-50">
                        ...
                        <div className="bannerform formshd">                           
                            <form id="contact-form" className='clientcornner pbb-20 ptt-50' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
