...
export default function MuseumCaper() {
  const MuseumCaperForm = async (event) => {
    ...
    xhttp.open(
      "Post",
      "https://byldgroup.in/eaglesflightindia/wp-json/contact-form-7/v1/contact-forms/14/feedback"
    );
  ...
  return (
    <>
      <Head>
        <title>
          Museum Caper - Virtual Team-Building Activity Offered by Eagle's
          Flight India.
        </title>
        <link
          rel="canonical"
          href="https://byldgroup.com/eaglesflightindia/our-offerings/museum-caper"
        />
        <meta
          name="description"
          content="Explore Museum Caper – a virtual team-building activity by Eagle's Flight India that boosts problem-solving, communication, and teamwork through a high-energy, interactive mystery challenge."
        />
      </Head>
        ...
        <div className="container-full">
          <div className="row y-middle">
            <div className="col-lg-12">
              <img
                className="img100"
                src="/efassets/img/banner/museum-caper-banner.jpg"
                alt="museum-caper-banner"
              />
            </div>
          </div>
        </div>
      ...
      <div class="rs-about style4  mtt-60">
        <div class="container">
            ...
            <div className="col-lg-6">
              <div class="sec-title3 mbb-35 text-left onlyshd">
                <h1 class="countertoph2 text-left font36">
                  Introducing Museum Caper
                  <sup style={{ fontSize: "11px" }}>TM</sup> Unfold The Mystery
                  to success!
                </h1>
          ...
          <div class="row y-middle">
            <div class="col-lg-6">
              <div class="sec-title3 mbb-35 text-left onlyshd">
                <h class="countertoph2 text-left font28">
                  Top Virtual Team-Building Activities for Employees
                </h>
                <div class="heading-border-line left-style"></div>
                <p class="mtt-40 justify">
                  In Eagle’s Flight’s mystery-themed virtual experiential
                  activity, Museum Caper™, participants work in teams as
                  detectives to track down the culprits of three major robberies
                  using the evidence left at the scene of each crime.
                </p>
                <p className="justify">
                  By cross-referencing the clues they receive, they eliminate
                  suspects and identify the true criminals. Involve in a virtual
                  world of Museum Caper™ to identify the three best practices to
                  succeed by conducting outdoor team building activities.
                </p>
                <div class="btn-part ptt-10 pbb-30">
                  <a
                    class="readon2"
                    target="_blank"
                    href="https://ik.imagekit.io/byld/EF/1%20again_uRYEZacKu.pdf?updatedAt=1708517913734"
                  >
                    DOWNLOAD BROCHURE
            ...
            <div className="col-lg-6">
              <img
                className="img100"
                src="/efassets/img/virtual-team-building-inner.png"
              />
            </div>
          </div>
        </div>
            ...
            <div className="col-lg-6 pr-0">
              <div className="onlyshd">
                ...
                <div className="rs-estimate">
                  ...
                  <ul className="estimate-info mtt-5">
                    <li>
                      Provide timely feedback that can keep the team progressing
                      to the goal
                    </li>
                    <li>
                      A team’s productivity increases with virtual team building
                ...
                <div className="btn-part ptt-10 pbb-30">
                  <Link href="#get-in-touch">
                    <a className="readon2">Try the Demo</a>
                  </Link>
                </div>
              </div>
            </div>
