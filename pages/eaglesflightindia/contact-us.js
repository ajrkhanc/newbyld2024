...
export default function Blog(){
    ...
    const EDcontactUs = async event => {
        ...
        xhttp.open("Post", 'https://byldgroup.in/eaglesflightindia/wp-json/contact-form-7/v1/contact-forms/12/feedback');
                            ...
                            <form id="contact-form" className='clientcornner ptt-40 pbb-20' onSubmit={EDcontactUs}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-6 mb-12 d-none">
                                            <input type="text" name="Business_Entity" value="Eagle’s Flight" required />
                                        </div>
                                        <div className="col-lg-12 mb-12">
